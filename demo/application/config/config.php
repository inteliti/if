...
/*
 ...
 | unicamente el nombre de la carpeta sin '/' al inicio ni al final. 
 | 
 | Si en algun momento se desea cambiar la plantilla simplemente se 
...
|
*/
$config['encryption_key'] = 'd9a425b17d2ca562c3fed8e378a4770f';
...
$config['sess_save_path'] = 'if_sessions';
...
$config['csrf_token_name'] = 'csrf_if_protection';
$config['csrf_cookie_name'] = 'csrf_cookie_if_protection';
